...
export const TIMING = {
  ...
  CANCEL_COMPENSATION_TIMEOUT_MS: getEnvDuration('REPL_CANCEL_COMPENSATION_TIMEOUT', 600_000), // 10m
  ...
  // DESTRUCTIVE INTENT
  DESTRUCTIVE_INTENT_TTL_MS: getEnvDuration('REPL_DESTRUCTIVE_INTENT_TTL', 300_000), // 5m
  ...
  // SETTLEMENT WINDOWS (per-provider billing API delay)
  SETTLEMENT_WINDOW_AWS_MS: getEnvDuration('REPL_SETTLEMENT_WINDOW_AWS', 172_800_000), // 48h
  SETTLEMENT_WINDOW_LAMBDA_MS: getEnvDuration('REPL_SETTLEMENT_WINDOW_LAMBDA', 604_800_000), // 7d
  SETTLEMENT_WINDOW_DO_MS: getEnvDuration('REPL_SETTLEMENT_WINDOW_DO', 86_400_000), // 24h
  SETTLEMENT_WINDOW_RUNPOD_MS: getEnvDuration('REPL_SETTLEMENT_WINDOW_RUNPOD', 86_400_000), // 24h

  // RECONCILIATION ALERT THRESHOLDS
  RECONCILIATION_WARN_THRESHOLD_CENTS: parseInt(process.env.REPL_RECON_WARN_CENTS || '100', 10), // $1
  RECONCILIATION_WARN_THRESHOLD_PCT: parseInt(process.env.REPL_RECON_WARN_PCT || '1', 10), // 1%
  RECONCILIATION_ALERT_THRESHOLD_CENTS: parseInt(process.env.REPL_RECON_ALERT_CENTS || '1000', 10), // $10
  RECONCILIATION_ALERT_THRESHOLD_PCT: parseInt(process.env.REPL_RECON_ALERT_PCT || '5', 10), // 5%

  // BILLING RECONCILIATION JOB
  BILLING_RECONCILIATION_INTERVAL_MS: getEnvDuration('REPL_BILLING_RECON_INTERVAL', 86_400_000), // 24h (daily)
